"""
FILE: quiz_solver.py
Core logic for solving quizzes
"""
...
class QuizSolver:
    ...
    async def render_page(self, url):
        ...
        try:
            ...
            async with async_playwright() as p:
                # Launch browser with additional args for Render
                browser = await p.chromium.launch(
                    headless=True,
                    args=[
                        '--no-sandbox',
                        '--disable-setuid-sandbox',
                        '--disable-dev-shm-usage',  # Disable /dev/shm for low memory
                    ]
                )
            ...
            raise Exception("Playwright library not installed")
        except Exception as e:
    ...
    def execute_plan(self, plan, question, quiz_url, html):
        ...
        elif 'api' in question.lower() or 'endpoint' in question.lower():
        ...
        elif 'chart' in question.lower() or 'graph' in question.lower():
